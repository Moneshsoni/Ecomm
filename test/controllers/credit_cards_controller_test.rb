...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference("CreditCard.count") do
      post credit_cards_url, params: { credit_card: { digits: @credit_card.digits, month: @credit_card.month, user_id: @credit_card.user_id, year: @credit_card.year } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { digits: @credit_card.digits, month: @credit_card.month, user_id: @credit_card.user_id, year: @credit_card.year } }
